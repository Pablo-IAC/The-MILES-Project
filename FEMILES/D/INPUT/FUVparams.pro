...
;!p.multi=0
set_plot,'ps'
device,filename='FUVparams.eps',xsize=24,ysize=26,yoffset=1.,/color
erase
;
x1=-2.499
x2=0.9999
...
,xtitle=xtit,ytitle=ytit,psym=4,symsize=0.65,charsize=1.6,/NOERASE,$
yticks=n_elements(y_tickv)-1, ytickv=y_tickv, ytickn=y_tickn
;
xyouts,xyo,yyo,'Dwarfs',charsize=1.8
;xyouts,-2.6,11850.,'T!deff!n (x 10!e3!n K)',orientation=90,charsize=1.8
...
yrange=[y1,y2],ystyle=1,xtitle=xtit,symsize=0.65,psym=4,charsize=1.6,$
yticks=n_elements(y_tickv)-1,ytickv=y_tickv,ytickn=y_tickn,ycharsize=0.0001,/NOERASE
