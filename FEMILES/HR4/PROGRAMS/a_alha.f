...
c	    ZMU=zi(NNN)
       ...
       IF(shape.eq.'b')THEN
         ...
         if(iaba.eq.0.and.iabaj.eq.1)then
	  chatb='./OUT/B/Bbi'//chato
	  chator='./OUT/R/Rbi'//chato
	 endif
       ...
       ELSEIF(shape.eq.'u')THEN
         write(chato(1:4),'(f4.2)')ZMU-1.0d0
         if(iaba.eq.0.and.iabaj.eq.1)then
	  chatb='./OUT/B/Bun'//chato
          chator='./OUT/R/Run'//chato
	 endif
       ...
       ELSEIF(shape.eq.'k')THEN
         write(chato(1:4),'(f4.2)')ZMU-1.0d0
         if(iaba.eq.0.and.iabaj.eq.1)then
	  chatb='./OUT/B/Bku'//chato
          chator='./OUT/R/Rku'//chato
	 endif
       ...
       ELSEIF(shape.eq.'r')THEN
         write(chato(1:4),'(f4.2)')ZMU-1.0d0
         if(iaba.eq.0.and.iabaj.eq.1)then
	  chatb='./OUT/B/Bkb'//chato
	  chator='./OUT/R/Rkb'//chato
	 endif
       ...
       ELSEIF(shape.eq.'c')THEN
         write(chato(1:4),'(f4.2)')ZMU-1.0d0
         if(iaba.eq.0.and.iabaj.eq.1)then
	  chatb='./OUT/B/Bch'//chato
	  chator='./OUT/R/Rch'//chato
	 endif
       ...
       ELSEIF(shape.eq.'f')THEN
         write(chato(1:4),'(f4.2)')ZMU-1.0d0
         if(iaba.eq.0.and.iabaj.eq.1)then
	  chatb='./OUT/B/BFe'//chato
	  chator='./OUT/R/RFe'//chato
	 endif
       ...
       ELSEIF(shape.eq.'x')THEN
         write(chato(1:4),'(f4.2)')ZMU-1.0d0
         if(iaba.eq.0.and.iabaj.eq.1)then
	  chatb='./OUT/B/BFx'//chato
	  chator='./OUT/R/RFx'//chato
	 endif
       ...
       ELSEIF(shape.eq.'l')THEN
         ...
         if(ZMU1.ge.0.0d0)then
           if(int1.lt.10)then
              ...
              if(iaba.eq.0.and.iabaj.eq.1)then
	       chatb='./OUT/B/Bp0'//chato
	       chator='./OUT/R/Rp0'//chato
	      endif
              ...
              if(iaba.eq.0.and.iabaj.eq.1)then
	       chatb='./OUT/B/Bp'//chato
	       chator='./OUT/R/Rp'//chato
	      endif
           ...
           if(int1.lt.10)then
              write(chato(1:1),'(I1)')int1
              if(iaba.eq.0.and.iabaj.eq.1)then
	       chatb='./OUT/B/Bm0'//chato
	       chator='./OUT/R/Rm0'//chato
	      endif
              ...
              write(chato(1:2),'(I2)')int1
              if(iaba.eq.0.and.iabaj.eq.1)then
	       chatb='./OUT/B/Bm'//chato
	       chator='./OUT/R/Rm'//chato
	      endif
         ...
         if(ZMU2.ge.0.0d0)then
	      ...
	      if(iaba.eq.0.and.iabaj.eq.1)then 
               write(chatb(13:15),'(A3)')'p0'//chato
               write(chator(13:15),'(A3)')'p0'//chato
	      endif
	      ...
	      if(iaba.eq.0.and.iabaj.eq.1)then 
               write(chatb(13:15),'(A3)')'p'//chato
               write(chator(13:15),'(A3)')'p'//chato
	      endif
           ...
           if(int2.lt.10)then
              write(chato(1:1),'(I1)')int2
 	      if(iaba.eq.0.and.iabaj.eq.1)then 
               write(chatb(13:15),'(A3)')'m0'//chato
               write(chator(13:15),'(A3)')'m0'//chato
	      endif
              ...
              write(chato(1:2),'(I2)')int2
	      if(iaba.eq.0.and.iabaj.eq.1)then 
               write(chatb(13:15),'(A3)')'m'//chato
               write(chator(13:15),'(A3)')'m'//chato
	      endif
...
c Fracciones bolometricas:
     ...
     &qu15o,fxUmo,fxUio,fxUo,fxUmso,fxUiso,fxUso,fxUis004o,abolo)
	  attao=realeo
...
C Abierto loop Tyng
     ...
     &t222y,g222y,f222y,Wfcatty,hy,fluxxy,qumy,qu10y,qu05y,qu15y,fxUmy,
     &fxUiy,fxUy,fxUmsy,fxUisy,fxUsy,fxUis004y,aboly)
             attao=realey
	     if(attao.lt.10.0d0)then
	      write(chato(1:8),'(A,A,f6.4)')'T','0',attao
	     else
...
c U fluxes
            ...
            fxUtis004=(alpha*BETAo*fxUis004o+(1.0d0-alpha)*BETAy*
     &fxUis004y)
