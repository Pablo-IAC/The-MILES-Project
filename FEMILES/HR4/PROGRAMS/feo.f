      ...
      COMMON/ab/iaba
      COMMON/jmik/jmiku(20),lenj(20) !nombre dirs estrellas
c      COMMON/jmik2/ctunn,lctunn
      jmiku(1)='../D/SL_BASE/STARS_4/'
      jmiku(2)='../D/SL_BASE/STARS_5/'
      IF(iaba.ge.1.or.iaba.le.3)THEN
       if(iaba.lt.3)then
...
c	 write(ctunn(1:lctun-1)
	...
	jmiku(4)='../D/SL_ADAM/STARS_C_CFe' !solo M disponible
	jmiku(5)='../D/SL_ADAM/STARS_I_CFe' !solo M disponible
	jmiku(6)='../D/SL_ADAM/STARS_K_CFe' !solo M disponible
	jmiku(7)='../D/SL_ADAM/STARS_U_CFe' !solo M disponible
	do iku=3,7 !solo M disponible
