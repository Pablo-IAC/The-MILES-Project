...
c	  estoy integrando en masa para obtener la BETA con masas vivas
	  BETA=BETA+fim*dm
...
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
	...
	xmaso=ZMISO
	xmasa=ZMISA
      CALL hrsl_IRTF(m,xm9,xm9s,a9m,f9m,qum,qu10,qu05,qu15)
      RETURN
      END
