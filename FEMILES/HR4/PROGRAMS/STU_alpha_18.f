...
c**********************************************************
      SUBROUTINE STU_alpha(m,ageSSP,BETA,reale,ZZZ,ZMISO,vsin,stm
     & ,b9,v9,c9,xm9,a9,f9,a9c,f9c,a9m,f9m,ZISOL,fZISOL,VM,dwgi,ZZZsbf
     ...
     &,fZISOL(8),a9m(5)
      DIMENSION b9(1120,2),v9(1120,2),c9(710,2)
	DIMENSION xm9(npxm,2)
...
c	  elseif(i.ge.keypT(17).and.colojk.lt.1.4)then !Oxygen-rich stars
	 if(Rm0(m,i,1).le.0.50d0) frbol(15)=frbol(15)+R1415 !<20.5Mo
       if(i.gt.keypT(17).and.i.le.keypT(18).and.colojk.ge.1.4d0)!good for Z008
     &frbol(13)=frbol(13)+R1415 !C-rich
       if(i.gt.keypT(17).and.i.le.keypT(18).and.colojk.lt.1.4d0)!good for Z008 
     &frbol(12)=frbol(12)+R1415 !O-rich
       if(i.gt.keypT(17).and.i.le.keypT(18).and.colojk.ge.1.3d0)!good for Z008
     &frbol(11)=frbol(11)+R1415 !C-rich
       if(i.gt.keypT(17).and.i.le.keypT(18).and.colojk.lt.1.3d0)!good for Z008 
     &frbol(10)=frbol(10)+R1415 !O-rich
       if(i.gt.keypT(17).and.i.le.keypT(18).and.colojk.ge.1.2d0)!good for Zsun
     &frbol(9)=frbol(9)+R1415 !C-rich
       if(i.gt.keypT(17).and.i.le.keypT(18).and.colojk.lt.1.2d0)!good for Zsun 
...
c	para out_phot y out_sbf
	  ...
	  if(z(m,kk,13).gt.1.d0.and.z(m,kk,3).gt.4.d0.and.z(m,kk,4).gt.3.d0)then
c	 write(*,*)z(m,kk,13),z(m,kk,3),z(m,kk,4),dm
	  ZZZwd(lnk-4)=ZZZwd(lnk-4)+R(m,i,14)*R(m,i,lnk)
	  endif
	  if(z(m,kk,13).lt.1.05d0)then
c	 write(*,*)z(m,kk,13),z(m,kk,3),z(m,kk,4),dm
	  ZZZms(lnk-4)=ZZZms(lnk-4)+R(m,i,14)*R(m,i,lnk)
	  endif
...
c	 ZISOL(lnk)=ZMISO*xLsol(lnk)/(BETA*ZZZ(lnk))
	 ...
	 write(*,*)lnk,ZZZwd(lnk)/ZZZ(lnk)
	 write(*,*)lnk,ZZZms(lnk)/ZZZ(lnk)
	enddo
c LLAMADA A LAS SUBRUTINAS ESPECTROSCOPICAS
      CALL hrsl_alpha(m,b9,v9,c9,xm9,a9,f9,a9c,f9c,a9m,f9m,
     &Wfcatt,qum,qu10,qu05,qu15,fxUm,fxUi,fxU,fxUms,fxUis,fxUs,fxUis004)
      IF(iaba.eq.0)THEN
...
c transfiero el coef corrector fnc1 (cont1) de subrout. hrsl
	...
	ENDIF
c      write(62,'(A44,14(1X,F7.4))')chatom,
c     &(100.0d0*(frbol(nt)/frbolt),nt=1,13),
