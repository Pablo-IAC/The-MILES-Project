...
c
5478  write(*,*)
     &'MILES(m),XSL(x),NGSL(u),IRTF(k),XSL_R1000(h),ALL[NOT h](a)?'
      read(*,*)miuk
      ...
      ELSEIF(miuk.eq.'h'.or.miuk.eq.'H')THEN
       miuk='h'
       dirout='ls ./OUT'
       mkout='mkdir ./OUT && cd OUT && mkdir H h'
...
c
	 ...
	 call matinx(a)
      ...
      elseif(shape.eq.'t') then
       write(*,'(A)')' Baumgardt MF shape'
      elseif(shape.eq.'k') then
       write(*,'(A)')'KROUPA UNIVERSAL IMF shape'
...
c un solo calculo
      IF(shape.eq.'k'.or.shape.eq.'r'.or.shape.eq.'t')THEN
         nnIMF=1
...
=======
	 READ(99,*,err=11111,end=11111)(z(m,I,J),J=1,16)
>>>>>>> 2e0a0d0 (Mensaje inicial desde terminal)
...
=======
       	   READ(23,*,err=11107,end=11107)(g(m,I,J),J=1,7),tin,tin,tin,gc(m,I)
>>>>>>> 2e0a0d0 (Mensaje inicial desde terminal)
       	   ng(m)=I
	 ENDDO
	endif
...
=======
       	   READ(24,*,err=11108,end=11108)tin,re(m,1,I),re(m,2,I)
>>>>>>> 2e0a0d0 (Mensaje inicial desde terminal)
       	   nr(m)=I
	ENDDO
11108	CLOSE (24)
...
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
         CALL a_XSL_276A ! ANULAR ANULAR ANULAR ANULAR !!!!!!!!!!!!!!
c         CALL a_XSL  !ACTIVAR ACTIVAR ACTIVAR ACTIVAR !!!!!!!!!!!!!!
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
cc	 CLOSE(49)
	 CLOSE(50)
      ENDIF
c      IF(miuk.eq.'h'.or.miuk.eq.'a')THEN
      IF(miuk.eq.'h')THEN
cc	 OPEN(49,FILE='./OUT/out_u_X',STATUS='OLD',ERR=6648)
cc	 CLOSE(49,STATUS='DELETE')
cc6648	 OPEN(49,IOSTAT=IOS,FILE='./OUT/out_u_X',STATUS='NEW')
	 OPEN(53,FILE='./OUT/out_ef_H',STATUS='OLD',ERR=6653)
	 CLOSE(53,STATUS='DELETE')
6653	 OPEN(53,IOSTAT=IOS,FILE='./OUT/out_ef_H',STATUS='NEW')
     	 OPEN(3993,FILE='./OUT/out_qua_H',STATUS='OLD',ERR=6654)
	 CLOSE(3993,STATUS='DELETE')
6654	 OPEN(3993,IOSTAT=IOS,FILE='./OUT/out_qua_H',STATUS='NEW')
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
         CALL a_XSL_276A  !!! CAMBIAR A a_XSL !!!
c         CALL a_XSL
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
cc	 CLOSE(49)
	 CLOSE(53)
