c*****SUBRUTINA QUE ESCRIBE LOS RESULTADOS******************************
      SUBROUTINE e_NGSL(alpha,izo,realeo,izy,realey)
      ...
      zetao=fez(izo)
c    escribe en out_ef
      write(51,'(A2,1x,(F5.2,1x),5(F7.4,1x),1(F6.0,2(1x,F6.3)))')
     &shapa,ZMU-1.d0,zetao,realeo,zetay,reay,alpha,(a90u(nt),nt=1,3)
c    escribe en out_qua
      write(3999,'(A2,1x,(F5.2,1x),2(F7.4,1x),7(F12.8))')shapa,ZMU-1.0d0
