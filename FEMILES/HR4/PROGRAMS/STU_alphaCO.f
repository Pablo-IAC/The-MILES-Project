...
c**********************************************************
      SUBROUTINE STU_alphaCO(npxm,m,ageSSP,BETA,reale,ZZZ,ZMISO,vsin,stm,b9
     ...
     &  ,fZISOL(8)
      ...
      DIMENSION h(5,9)
      CHARACTER*4 gc
      DIMENSION gsi(5,2),Rm0(12,2999,1)
c      COMMON/AGBpad/gsi(5,2),Rm0(12,2999,1)
...
c	para out_dg
	  ...
	  ENDIF
	 enddo
c	write(*,*)'reale   3',reale,z(m,kk,13)
...
c10000	continue
	...
	enddo
      CALL hrsl_alphaCO(npxm,m,b9,v9,c9,xm9,a9,f9,a9c,f9c,a9m,f9m,Wfcatt,
