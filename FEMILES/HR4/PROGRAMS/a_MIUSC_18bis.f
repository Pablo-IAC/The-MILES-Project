...
c*******COMIENZO DEL BUCLE DE LA SSPo**********************************
	  DO izo=1,nzold
	   ...
	   DO iao=1,ntold
	    ageo=ttold(iao)
          call STU_MIUSC(izold(izo),ageo,BETAo,realeo,ZMISOo,
     &wwffio,a9io,f9mo,qumo,qu10o,qu05o,qu15o,fxUmo,fxUio,fxUo,
...
c*******COMIENZO DEL BUCLE DE LA SSPy**********************************
     ...
     &abs(pizyng(izyng(izy)))
		...
		agey=ttyng(iay)
	      ...
	      IF(alpha.ne.1.0d0)THEN
	       call STU_MIUSC(izyng(izy),agey,BETAy,realey,ZMISOy,
     &wwffiy,a9iy,f9my,qumy,qu10y,qu05y,qu15y,fxUmy,fxUiy,fxUy,
