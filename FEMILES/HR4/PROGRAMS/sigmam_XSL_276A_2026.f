      SUBROUTINE sigmam_XSL_276A(tiss,giss,fiss,ala,aloec)
CC Version 22-January-03-2014.
CC Version 26-February-03-2026 (updated DMA due to new stellar parameters)
C------------------------------------------------------------------------------
...
c	tz0_i=3500.0d0 !temp mas baja para la que distinguimos[M/H]
	...
	enddo
	DMA=190.0d0 !densidad limite (0.997 frac.cum.)
...
c      if(weifin.le.1.0d0)WRITE(*,*)'WEIFIN XSL LT ZERO'
