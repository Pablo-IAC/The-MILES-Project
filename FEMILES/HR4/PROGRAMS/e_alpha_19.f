...
515   FORMAT(A2,1x,(F5.2,1x),2(F7.4,1x),2(8(F5.2,1x),2x))
     ...
     &(DWGI(2,nt),nt=1,8)
c	escribe en out_u
514   FORMAT(A2,1x,(F5.2,1x),2(F7.4,1x),7(F14.8,1x))
      WRITE(29,514)shapa,ZMU-1.d0,zetao,realeo,fxUtm/fxUt,fxUti/fxUt,
     &fxUt,fxUtms/fxUts,fxUtis/fxUts,fxUtis004/fxUts,fxUts
...
511   FORMAT(A2,1x,(F5.2,1x),2(F7.4,1x),5(F8.4),3(1x,F8.3),1x,F15.8)
      WRITE(40,511)shapa,ZMU-1.d0,zetao,realeo,xmast,fmO,fmA,fmR,
     &(1.d0-fmO),ZISOL(3),(ZISOL(3)*(fmA/fmO)),ZZZ(3),fZISOL(3)
