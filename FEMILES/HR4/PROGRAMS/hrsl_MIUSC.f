...
c CaT y MILES para una terna de parametros atmosfericos. 
      SUBROUTINE hrsl_MIUSC(k,wfluji,wflujis,al99i,fja99i,qum,qu10,
     &qu05,qu15,fluxUm,fluxUi,fluxU,fluUms,fluUis,fluUs,fluUis004)
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c MIUSC
      PARAMETER (npxi=6672) !MIUSC
c
      DIMENSION ssppi(npxi,2),wfluji(npxi,2),wflujis(npxi,2)!MIUSC
