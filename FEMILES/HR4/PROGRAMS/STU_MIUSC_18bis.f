      SUBROUTINE STU_MIUSC(m,ageSSP,BETA,reale,ZMISO,xm9,a9m,f9m,
     &qum,qu10,qu05,qu15,fxUm,fxUi,fxU,fxUms,fxUis,fxUs,fxUis004)
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c MIUSC
	PARAMETER (npxi=6672) !IRTF #pixels in the spectra
      DIMENSION a9m(3),xm9(npxi,2)
c
...
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
	...
	xmaso=ZMISO
	xmasa=ZMISA
      CALL hrsl_MIUSC(m,xm9,a9m,f9m,qum,qu10,qu05,qu15,
