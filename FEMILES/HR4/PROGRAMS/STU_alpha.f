...
c**********************************************************
     ...
     &,abolo)
cc      SUBROUTINE STU_alpha(m,ageSSP,BETA,reale,ZZZ,ZMISO,vsin,stm,b9,
cc     &v9,c9,xm9,c9s,xm9s,a9,f9,a9c,f9c,a9m,f9m,ZISOL,fZISOL,VM,dwgi,
cc     &ZZZsbf,fhst,fhsbf,t22,g22,f22,Wfcatt,h,fluxx0,qum,qu10,qu05,qu15
cc     &,fxUm,fxUi,fxU,fxUms,fxUis,fxUs,fxUis004,abolo)
...
cccccccccccccccccccc
      if(i.eq.keypT(3))write(*,*)'Turn Off : ',Rm0(m,i,1),10**R(m,i,3),R(m,i,4)
      if(i.eq.keypT(5))write(*,*)'Base RGB : ',Rm0(m,i,1),10**R(m,i,3),R(m,i,4)
      if(i.eq.keypT(8))write(*,*)'Tip RGB  : ',Rm0(m,i,1),10**R(m,i,3),R(m,i,4)
      if(i.eq.keypT(9))write(*,*)'Start HB : ',Rm0(m,i,1),10**R(m,i,3),R(m,i,4)
      if(i.eq.keypT(15))write(*,*)'End HB   : ',Rm0(m,i,1),10**R(m,i,3),R(m,i,4)
cccccccccccccccccccc
         ENDIF
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
